...
import com.siarex247.cumplimientoFiscal.DescargaSAT.DescargaCFDIMetadataTimbrado;


public class TaskManagerDescargaMetadataTimbrado {
	
	private static TaskManagerDescargaMetadataTimbrado  _instance = null;
	private static Timer timerList = null;
	
	private final int NUMERO_PROCESO = 6;
	
	
	public static synchronized TaskManagerDescargaMetadataTimbrado instance() {
		if (_instance == null) {
			timerList = new Timer();
			_instance = new TaskManagerDescargaMetadataTimbrado();
		}
		return _instance;
	}
	...
	class TaskTimerProceso extends TimerTask {
		public void run() {
			...
			DescargaCFDIMetadataTimbrado descargaCFDI = new DescargaCFDIMetadataTimbrado();
    ...
    public static void main(String args[]){
    	TaskManagerDescargaMetadataTimbrado t = new TaskManagerDescargaMetadataTimbrado();
    	t.iniciarProceso();
    }
