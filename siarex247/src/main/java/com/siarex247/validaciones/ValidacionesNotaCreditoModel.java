...
public class ValidacionesNotaCreditoModel {

	
	private ArrayList<NotaCreditoForm> data;
	...
	public ArrayList<NotaCreditoForm> getData() {
		return data;
	}
	public void setData(ArrayList<NotaCreditoForm> data) {
		this.data = data;
	}
