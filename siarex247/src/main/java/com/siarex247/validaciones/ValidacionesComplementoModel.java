...
public class ValidacionesComplementoModel {

	
	private ArrayList<ComplementosForm> data;
	...
	public ArrayList<ComplementosForm> getData() {
		return data;
	}
	public void setData(ArrayList<ComplementosForm> data) {
		this.data = data;
	}
