...
public class ListaNegraPDFNoEncontrado {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String razonSocial = "JOSE GUADALUPE BURGOS MARTINEZ" ;
        String rfc = "BUMG8008188A4";
        String tipoPersona = "PERSONA MORAL";
        String nombreUsuario = "ADMINISTRADOR SIAREX";
        
        new ListaNegraPDFNoEncontrado().crearPDF(salida, imagePathOrClasspath, razonSocial, rfc, tipoPersona,  nombreUsuario, 1);
    ...
    public void crearPDF(Path outputPdf,
        ...
        try (PdfWriter writer = new PdfWriter(outputPdf.toFile());
            ...
            // ======= TABLA DETALLES (3x2) =======
/*            
            Table leftDetails = new Table(UnitValue.createPercentArray(new float[]{25f, 75f}))
...
*/            
           ...
           // leftStack.add(leftDetails);
            ...
            resultado.addCell(new Cell()
                    ...
                    .setBorder(Border.NO_BORDER).setTextAlignment(TextAlignment.LEFT));
            resultado.addCell(new Cell()
                    .add(new Paragraph("Sin Publicación").setFont(arial).setFontSize(15)).setFontColor(azul).setBold()
                    .setBorder(Border.NO_BORDER).setTextAlignment(TextAlignment.LEFT));
            
            doc.add(resultado);
            /*
            Paragraph resultado = new Paragraph("Resultado búsqueda: Sin Publicación")
                    .setFont(arial).setFontSize(15).setBold().setFontColor(azul)
                    .setTextAlignment(TextAlignment.LEFT);
            doc.add(resultado);
			*/
