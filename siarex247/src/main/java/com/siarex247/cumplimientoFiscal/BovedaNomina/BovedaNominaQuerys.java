...
public class BovedaNominaQuerys {
	...
	//private static String detalleBoveda =  "select ID_REGISTRO, UUID, SERIE, FOLIO,FECHA_FACTURA, METODO_PAGO, MONEDA, SUB_TOTAL, TOTAL, DESCUENTO, TOTAL_PERCEPCIONES, TOTAL_DEDUCCIONES, EMISOR_RFC, EMISOR_NOMBRE, RECEPTOR_RFC, RECEPTOR_NOMBRE, TIPO_COMPROBANTE, FECHA_TIMBRADO from BOVEDA_NOMINA E where E.TIPO_COMPROBANTE = ?";
	   private static String detalleBoveda =
	            "select E.ID_REGISTRO, E.UUID, E.SERIE, E.FOLIO, E.FECHA_FACTURA, E.METODO_PAGO, E.MONEDA, E.SUB_TOTAL, E.TOTAL, E.DESCUENTO, "
	            + "E.TOTAL_PERCEPCIONES, E.TOTAL_DEDUCCIONES, E.EMISOR_RFC, E.EMISOR_NOMBRE, E.RECEPTOR_RFC, E.RECEPTOR_NOMBRE, "
	            + "E.TIPO_COMPROBANTE, E.FECHA_TIMBRADO, E.TOTAL_OTROS, "
	            + "IFNULL(P.TOTAL_EXCENTO, 0) as TOTAL_EXCENTO, IFNULL(P.TOTAL_GRAVADO, 0) as TOTAL_GRAVADO "
	            + "from BOVEDA_NOMINA E "
	            + "left join ( "
	            + "  select UUID as UUIDP, sum(TOTAL_EXCENTO) as TOTAL_EXCENTO, sum(TOTAL_GRAVADO) as TOTAL_GRAVADO "
	            + "  from BOVEDA_NOMINA_PERCEPCIONES "
	            + "  group by UUID "
	            + ") P on E.UUID = P.UUIDP "
	            + "where 1=1 ";
	//private static String totalRegistros =  "select count(*) from BOVEDA_NOMINA E where TIPO_COMPROBANTE = ?";
	    private static String totalRegistros = "select count(1) from BOVEDA_NOMINA E where 1=1";
    ...
    private static String consultaBoveda = "select E.ID_REGISTRO, E.UUID, E.SERIE, E.FOLIO, E.FECHA_FACTURA, E.METODO_PAGO, E.MONEDA, E.SUB_TOTAL, E.TOTAL, E.DESCUENTO, E.TOTAL_PERCEPCIONES, E.TOTAL_DEDUCCIONES, E.EMISOR_RFC, E.EMISOR_NOMBRE, E.RECEPTOR_RFC, E.RECEPTOR_NOMBRE, E.TIPO_COMPROBANTE, E.FECHA_TIMBRADO from BOVEDA_NOMINA E where E.ID_REGISTRO = ?";
    ...
    private static String reporteDetalle = "select E.ID_REGISTRO, E.UUID, E.SERIE, E.FOLIO, E.FECHA_FACTURA, E.METODO_PAGO, E.MONEDA, E.SUB_TOTAL, E.TOTAL, E.DESCUENTO, E.TOTAL_PERCEPCIONES, E.TOTAL_DEDUCCIONES, E.EMISOR_RFC, E.EMISOR_NOMBRE, E.RECEPTOR_RFC, E.RECEPTOR_NOMBRE, E.TIPO_COMPROBANTE, E.FECHA_TIMBRADO from BOVEDA_NOMINA E where E.TIPO_COMPROBANTE = ?";

    private static String detalleBovedaZIP = "select E.ID_REGISTRO, E.UUID, E.SERIE, E.FOLIO, E.FECHA_FACTURA, E.METODO_PAGO, E.MONEDA, E.SUB_TOTAL, E.TOTAL, E.DESCUENTO, E.TOTAL_PERCEPCIONES, E.TOTAL_DEDUCCIONES, E.EMISOR_RFC, E.EMISOR_NOMBRE, E.RECEPTOR_RFC, E.RECEPTOR_NOMBRE, E.TIPO_COMPROBANTE, E.FECHA_TIMBRADO from BOVEDA_NOMINA E where E.UUID = ?";

    private static String reporteResumen = "select ifnull(sum(E.SUB_TOTAL),0) as SUB_TOTAL, ifnull(sum(E.TOTAL),0) as TOTAL, ifnull(sum(E.DESCUENTO),0) as DESCUENTO, ifnull(sum(E.TOTAL_PERCEPCIONES),0) as TOTAL_PERCEPCIONES, ifnull(sum(E.TOTAL_DEDUCCIONES),0) as TOTAL_DEDUCCIONES from BOVEDA_NOMINA E where E.TIPO_COMPROBANTE = ?";
    ...
    public static String getDetalleBovedaZIP(String esquema) {
        return detalleBovedaZIP.replaceAll("#", esquema);
    }

    public static String getReporteResumen(String esquema) {
        return reporteResumen.replaceAll("#", esquema);
    }
