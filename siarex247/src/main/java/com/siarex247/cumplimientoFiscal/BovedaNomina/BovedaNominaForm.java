...
public class BovedaNominaForm {
	...
	private double importeGravadoDouble;
    ...
    public void setExentasOperator(String exentasOperator) { this.exentasOperator = exentasOperator; }
    public String getExentasV1() { return exentasV1; }
    public void setExentasV1(String exentasV1) { this.exentasV1 = exentasV1; }
    public String getExentasV2() { return exentasV2; }
    public void setExentasV2(String exentasV2) { this.exentasV2 = exentasV2; }

    public String getGravadasOperator() { return gravadasOperator; }
    public void setGravadasOperator(String gravadasOperator) { this.gravadasOperator = gravadasOperator; }
    public String getGravadasV1() { return gravadasV1; }
    public void setGravadasV1(String gravadasV1) { this.gravadasV1 = gravadasV1; }
    public String getGravadasV2() { return gravadasV2; }
    public void setGravadasV2(String gravadasV2) { this.gravadasV2 = gravadasV2; }

    public String getOtrosOperator() { return otrosOperator; }
    public void setOtrosOperator(String otrosOperator) { this.otrosOperator = otrosOperator; }
    public String getOtrosV1() { return otrosV1; }
    public void setOtrosV1(String otrosV1) { this.otrosV1 = otrosV1; }
    public String getOtrosV2() { return otrosV2; }
    public void setOtrosV2(String otrosV2) { this.otrosV2 = otrosV2; }
	...
	public double getImporteGravadoDouble() {
		return importeGravadoDouble;
	}
	public String getImporteExcento() {
		return importeExcento;
	}
	public double getImporteExcentoDouble() {
		return importeExcentoDouble;
	}
	...
	public void setDescuentoDouble(double descuentoDouble) {
		this.descuentoDouble = descuentoDouble;
	}
	...
	public void setImporteGravadoDouble(double importeGravadoDouble) {
		this.importeGravadoDouble = importeGravadoDouble;
	}
	public void setImporteExcento(String importeExcento) {
		this.importeExcento = importeExcento;
	}
	public void setImporteExcentoDouble(double importeExcentoDouble) {
		this.importeExcentoDouble = importeExcentoDouble;
	}
