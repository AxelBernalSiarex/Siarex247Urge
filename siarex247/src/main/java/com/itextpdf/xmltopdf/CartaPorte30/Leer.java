...
public class Leer {
    ...
    public static CartaPorte30 ObtenerNodoComplementoCartaPorte(Element documento) {
        NodeList listaCartaPorte = documento.getElementsByTagName("cartaporte30:CartaPorte");
        if (listaCartaPorte.getLength() == 0) {
            return null;
        }
        CartaPorte30 cartaPorte = new CartaPorte30();
        Element nodoCartaPorte = (Element) listaCartaPorte.item(0);
        if (!cartaPorte.getVersion().equals("3.0")) {
            return null;
        }
    ...
    private static Ubicaciones ObtenerUbicaciones(Element nodoCartaPorte) {
        ...
        NodeList listaUbicaciones = nodoCartaPorte.getElementsByTagName("cartaporte30:Ubicaciones");
    ...
    private static ArrayList<Ubicacion> ObtenerUbicacion(Element nodoUbicaciones) {
        ...
        NodeList nListaUbicacion = nodoUbicaciones.getElementsByTagName("cartaporte30:Ubicacion");
    ...
    private static Domicilio ObtenerDomicilio(Element nodoUbicacion) {
        ...
        NodeList listaDomicilios = nodoUbicacion.getElementsByTagName("cartaporte30:Domicilio");
    ...
    private static Mercancias ObtenerMercancias(Element nodoCartaPorte) {
        ...
        NodeList listaMercancias = nodoCartaPorte.getElementsByTagName("cartaporte30:Mercancias");
    ...
    private static ArrayList<Mercancia> ObtenerMercancia(Element nodoMercancias) {
        ...
        NodeList nListaMercancia = nodoMercancias.getElementsByTagName("cartaporte30:Mercancia");
    ...
    private static ArrayList<DocumentacionAduanera> ObtenerDocumentacionAduanera(Element nodoMercancia) {
        ...
        NodeList nListaPedimentos = nodoMercancia.getElementsByTagName("cartaporte30:DocumentacionAduanera");
    ...
    private static ArrayList<GuiasIdentificacion> ObtenerGuiasIdentificacion(Element nodoMercancia) {
        ...
        NodeList nListaGuiasIdentificacion = nodoMercancia.getElementsByTagName("cartaporte30:GuiasIdentificacion");
    ...
    private static ArrayList<CantidadTransporta> ObtenerCantidadTransporta(Element nodoMercancia) {
        ...
        NodeList nlistaCantidadTransporta = nodoMercancia.getElementsByTagName("cartaporte30:CantidadTransporta");
    ...
    private static DetalleMercancia ObtenerDetalleMercancia(Element nodoMercancia) {
        ...
        NodeList listaDetalleMercancias = nodoMercancia.getElementsByTagName("cartaporte30:DetalleMercancia");
    ...
    private static Autotransporte ObtenerAutoTransporte(Element nodoMercancias) {
        ...
        NodeList listaAutotransporte = nodoMercancias.getElementsByTagName("cartaporte30:Autotransporte");
    ...
    private static IdentificacionVehicular ObtenerIdentificacionVehicular(Element nodoAutotransporteFederal) {
        ...
        NodeList listaIdentificacionVehicular = nodoAutotransporteFederal
                .getElementsByTagName("cartaporte30:IdentificacionVehicular");
    ...
    private static Seguros ObtenerSeguros(Element nodoAutoTransporte) {
        ...
        NodeList listaSeguros = nodoAutoTransporte.getElementsByTagName("cartaporte30:Seguros");
    ...
    private static Remolques ObtenerRemolques(Element nodoAutotransporteFederal) {
        ...
        NodeList listaRemolques = nodoAutotransporteFederal.getElementsByTagName("cartaporte30:Remolques");
    ...
    private static ArrayList<Remolque> ObtenerRemolque(Element nodoRemolques) {
        ...
        NodeList nListaRemolque = nodoRemolques.getElementsByTagName("cartaporte30:Remolque");
    ...
    private static TransporteMaritimo ObtenerTransporteMaritimo(Element nodoMercancias) {
        ...
        NodeList listaTransporteMaritimo = nodoMercancias.getElementsByTagName("cartaporte30:TransporteMaritimo");
    ...
    private static ArrayList<Contenedor> ObtenerContenedor(Element nodoTransporteMaritimo) {
        ...
        NodeList nListaContenedor = nodoTransporteMaritimo.getElementsByTagName("cartaporte30:Contenedor");
    ...
    private static RemolquesCCP ObtenerRemolquesCPP(Element nodoTransporteMaritimo) {
        ...
        NodeList listaRemolques = nodoTransporteMaritimo.getElementsByTagName("cartaporte30:RemolquesCPP");
        if (listaRemolques.getLength() == 0) {
            return null;
        }
        Element nodoRemolques = (Element) listaRemolques.item(0);
    ...
    private static ArrayList<RemolqueCCP> ObtenerRemolqueCCP(Element nodoRemolques) {
        ...
        NodeList nListaRemolqueCPP = nodoRemolques.getElementsByTagName("cartaporte30:RemolqueCCP");
    ...
    private static TransporteAereo ObtenerTransporteAereo(Element nodoMercancias) {
        ...
        NodeList listaTransporteAereo = nodoMercancias.getElementsByTagName("cartaporte30:TransporteAereo");
    ...
    private static TransporteFerroviario ObtenerTransporteFerroviario(Element nodoMercancias) {
        ...
        NodeList listaTransporteFerroviario = nodoMercancias.getElementsByTagName("cartaporte30:TransporteFerroviario");
    ...
    private static ArrayList<DerechosDePaso> ObtenerDerechosDePaso(Element nodoTransporteFerroviario) {
        ...
        NodeList nlistaDerechosDePaso = nodoTransporteFerroviario.getElementsByTagName("cartaporte30:DerechosDePaso");
    ...
    private static ArrayList<Carro> ObtenerCarro(Element nodoTransporteFerroviario) {
        ...
        NodeList nlistaCarro = nodoTransporteFerroviario.getElementsByTagName("cartaporte30:Carro");
    ...
    private static ArrayList<CarroContenedor> ObtenerContenedorCarro(Element nodoCarro) {
        ...
        NodeList nlistaContenedor = nodoCarro.getElementsByTagName("cartaporte30:Contenedor");
        for (int i = 0; i < nlistaContenedor.getLength(); i++) {
            Element item = (Element) nlistaContenedor.item(i);
    ...
    private static FiguraTransporte ObtenerFiguraTransporte(Element nodoCartaPorte) {
        ...
        NodeList listaFiguraTransporte = nodoCartaPorte.getElementsByTagName("cartaporte30:FiguraTransporte");
    ...
    private static ArrayList<TiposFigura> ObtenerTiposFigura(Element nodoFiguraTransporte) {
        ...
        NodeList nListaTiposFigura = nodoFiguraTransporte.getElementsByTagName("cartaporte30:TiposFigura");
    ...
    private static ArrayList<PartesTransporte> ObtenerPartesTransporte(Element nodoTiposFigura) {
        ...
        NodeList nListaPartesTransporte = nodoTiposFigura.getElementsByTagName("cartaporte30:PartesTransporte");
