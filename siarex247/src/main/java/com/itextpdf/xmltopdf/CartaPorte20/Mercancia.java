...
public class Mercancia {
    ...
    private ArrayList<Pedimentos> pedimentos;
    ...
    public final ArrayList<Pedimentos> getPedimentos() {
        return this.pedimentos;
    }

    public final void setPedimentos(ArrayList<Pedimentos> value) {
        this.pedimentos = value;
    }
