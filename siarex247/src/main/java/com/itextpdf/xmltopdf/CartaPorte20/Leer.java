...
public class Leer {
    ...
    public static CartaPorte20 ObtenerNodoComplementoCartaPorte(Element documento) {
        CartaPorte20 cartaPorte = new CartaPorte20();
        NodeList listaCartaPorte = documento.getElementsByTagName("cartaporte20:CartaPorte");
        ...
        if (!cartaPorte.getVersion().equals("2.0")) {
            return null;
        }
    ...
    private static Ubicaciones ObtenerUbicaciones(Element nodoCartaPorte) {
        ...
        NodeList listaUbicaciones = nodoCartaPorte.getElementsByTagName("cartaporte20:Ubicaciones");
    ...
    private static ArrayList<Ubicacion> ObtenerUbicacion(Element nodoUbicaciones) {
        ...
        NodeList nListaUbicacion = nodoUbicaciones.getElementsByTagName("cartaporte20:Ubicacion");
    ...
    private static Domicilio ObtenerDomicilio(Element nodoUbicacion) {
        ...
        NodeList listaDomicilios = nodoUbicacion.getElementsByTagName("cartaporte20:Domicilio");
    ...
    private static Mercancias ObtenerMercancias(Element nodoCartaPorte) {
        ...
        NodeList listaMercancias = nodoCartaPorte.getElementsByTagName("cartaporte20:Mercancias");
    ...
    private static ArrayList<Mercancia> ObtenerMercancia(Element nodoMercancias) {
        ...
        NodeList nListaMercancia = nodoMercancias.getElementsByTagName("cartaporte20:Mercancia");
        for (int i = 0; i < nListaMercancia.getLength(); i++) {
            Element item = (Element) nListaMercancia.item(i);
            Mercancia mercancia = new Mercancia();
            mercancia.setPedimentos(ObtenerPedimentos(item));
    ...
    private static ArrayList<Pedimentos> ObtenerPedimentos(Element nodoMercancia) {
        ArrayList<Pedimentos> listaPedimentos = new ArrayList<>();
        NodeList nListaPedimentos = nodoMercancia.getElementsByTagName("cartaporte20:Pedimentos");
        for (int i = 0; i < nListaPedimentos.getLength(); i++) {
            Element item = (Element) nListaPedimentos.item(i);
            Pedimentos pedimentos = new Pedimentos();
            if (item.hasAttribute("Pedimentos")) {
                pedimentos.setPedimento(item.getAttribute("Pedimentos"));
            }
    ...
    private static ArrayList<GuiasIdentificacion> ObtenerGuiasIdentificacion(Element nodoMercancia) {
        ...
        NodeList nListaGuiasIdentificacion = nodoMercancia.getElementsByTagName("cartaporte20:GuiasIdentificacion");
        for (int i = 0; i < nListaGuiasIdentificacion.getLength(); i++) {
            ...
            if (item.hasAttribute("DescripGuiaIdentificacion")) {
                guiasIdentificacion.setDescripGuiaIdentificacion(item.getAttribute("DescripGuiaIdentificacion"));
            }
    ...
    private static ArrayList<CantidadTransporta> ObtenerCantidadTransporta(Element nodoMercancia) {
        ...
        NodeList nlistaCantidadTransporta = nodoMercancia.getElementsByTagName("cartaporte20:CantidadTransporta");
    ...
    private static DetalleMercancia ObtenerDetalleMercancia(Element nodoMercancia) {
        ...
        NodeList listaDetalleMercancias = nodoMercancia.getElementsByTagName("cartaporte20:DetalleMercancia");
    ...
    private static Autotransporte ObtenerAutoTransporte(Element nodoMercancias) {
        ...
        NodeList listaAutotransporte = nodoMercancias.getElementsByTagName("cartaporte20:AutotransporteFederal");
    ...
    private static IdentificacionVehicular ObtenerIdentificacionVehicular(Element nodoAutotransporteFederal) {
        ...
        NodeList listaIdentificacionVehicular = nodoAutotransporteFederal
                .getElementsByTagName("cartaporte20:IdentificacionVehicular");
    ...
    private static Seguros ObtenerSeguros(Element nodoAutoTransporte) {
        ...
        NodeList listaSeguros = nodoAutoTransporte.getElementsByTagName("cartaporte20:Seguros");
    ...
    private static Remolques ObtenerRemolques(Element nodoAutotransporteFederal) {
        ...
        NodeList listaRemolques = nodoAutotransporteFederal.getElementsByTagName("cartaporte20:Remolques");
    ...
    private static ArrayList<Remolque> ObtenerRemolque(Element nodoRemolques) {
        ...
        NodeList nListaRemolque = nodoRemolques.getElementsByTagName("cartaporte20:Remolque");
    ...
    private static TransporteMaritimo ObtenerTransporteMaritimo(Element nodoMercancias) {
        ...
        NodeList listaTransporteMaritimo = nodoMercancias.getElementsByTagName("cartaporte20:TransporteMaritimo");
    ...
    private static ArrayList<Contenedor> ObtenerContenedor(Element nodoTransporteMaritimo) {
        ...
        NodeList nListaContenedor = nodoTransporteMaritimo.getElementsByTagName("cartaporte20:Contenedor");
    ...
    private static TransporteAereo ObtenerTransporteAereo(Element nodoMercancias) {
        ...
        NodeList listaTransporteAereo = nodoMercancias.getElementsByTagName("cartaporte20:TransporteAereo");
    ...
    private static TransporteFerroviario ObtenerTransporteFerroviario(Element nodoMercancias) {
        ...
        NodeList listaTransporteFerroviario = nodoMercancias.getElementsByTagName("cartaporte20:TransporteFerroviario");
    ...
    private static ArrayList<DerechosDePaso> ObtenerDerechosDePaso(Element nodoTransporteFerroviario) {
        ...
        NodeList nlistaDerechosDePaso = nodoTransporteFerroviario.getElementsByTagName("cartaporte20:DerechosDePaso");
    ...
    private static ArrayList<Carro> ObtenerCarro(Element nodoTransporteFerroviario) {
        ...
        NodeList nlistaCarro = nodoTransporteFerroviario.getElementsByTagName("cartaporte20:Carro");
    ...
    private static ArrayList<CarroContenedor> ObtenerContenedorCarro(Element nodoCarro) {
        ...
        NodeList nlistaContenedor = nodoCarro.getElementsByTagName("cartaporte20:Contenedor");
        for (int i = 0; i < nlistaContenedor.getLength(); i++) {
            Element item = (Element) nlistaContenedor.item(i);
    ...
    private static FiguraTransporte ObtenerFiguraTransporte(Element nodoCartaPorte) {
        ...
        NodeList listaFiguraTransporte = nodoCartaPorte.getElementsByTagName("cartaporte20:FiguraTransporte");
    ...
    private static ArrayList<TiposFigura> ObtenerTiposFigura(Element nodoFiguraTransporte) {
        ...
        NodeList nListaTiposFigura = nodoFiguraTransporte.getElementsByTagName("cartaporte20:TiposFigura");
    ...
    private static ArrayList<PartesTransporte> ObtenerPartesTransporte(Element nodoTiposFigura) {
        ...
        NodeList nListaPartesTransporte = nodoTiposFigura.getElementsByTagName("cartaporte20:PartesTransporte");
