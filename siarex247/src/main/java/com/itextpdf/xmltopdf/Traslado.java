...
public class Traslado {
     ...
     * @see Atributo requerido para señalar la suma de los atributos Base de los
    ...
    /**
     * @param value Requerido.
     * @see Atributo requerido para señalar la clave del tipo de impuesto
     *      traslado aplicable al concepto.
     */
    ...
    /**
     * @param value Requerido.
     * @see Atributo requerido para señalar el valor de la tasa o cuota del
     *      impuesto que se traslada por los conceptos amparados en el comprobante.
     */
    ...
    /**
     * @param value Requerido.
     * @see Atributo requerido para señalar la suma del importe del impuesto
