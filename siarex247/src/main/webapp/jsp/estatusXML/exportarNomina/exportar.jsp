...
<head>
  ...
  <meta http-equiv="Expires" content="0">
	...
	<script src='/siarex247/jsp/estatusXML/exportarNomina/exportar.js?v=<%=Utils.VERSION%>'></script>    
</head>
		   ...
		   <div id="overSeccionCA" class="overlay" style="display: none;text-align: right;">
			...
			<div class="p-2 pb-0">
				...
				<div id="divBusquedaRFC">
					...
					<div class="mb-2 row">
						<label class="col-sm-2 col-form-label" for="rfcEmpleado" id="EXPORTARXML_ETQ5">RFC</label>
						<div class="col-sm-4">
							<div class="form-group">
							<select class="form-select" id="rfcEmpleado" name="rfcEmpleado">
				...
				<div class="mb-2 row">
					<label class="col-sm-2 col-form-label" for="" id="EXPORTARXML_ETQ17">Descargar XML </label>
					<div class="col-sm-1">
						<div class="form-check form-switch">
					...
					<label class="col-sm-2 col-form-label" for="" id="EXPORTARXML_ETQ18">Validar XML</label>
					<div class="col-sm-1">
						<div class="form-check form-switch">
		           ...
		           type: 'POST',
				    ...
				    success: function(data){
				    	...
				    	$.each(data.data, function(key, text) {
					    	$('#rfcEmpleado').append($('<option></option>').attr('value', text.rfc).text(text.razonSocial));
				      	});
				    }
				});
			}catch(e) {
