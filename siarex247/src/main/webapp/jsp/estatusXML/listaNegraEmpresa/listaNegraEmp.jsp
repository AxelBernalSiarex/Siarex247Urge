...
<head>
  ...
  <script src="/siarex247/jsp/estatusXML/listaNegraEmpresa/listaNegraEmp.js?v=<%=Utils.VERSION %>"></script>
	...
	<div class="card-header">
		<div class="row flex-between-end">
			<div class="col-auto align-self-center">
				<h5 class="mb-0" data-anchor="data-anchor" id="LISTA_NEGRA_TITLE1">Lista Negra Empresa</h5>
			</div>
			<div class="col-auto d-flex">
				<div id="btnFilter_Visor" class="btn btn-outline-secondary me-1 mb-1 btn-sm btnClr"> 
					<span class="fas fa-external-link-alt" data-fa-transform="shrink-3 down-2"></span>
					<span class="d-none d-sm-inline-block ms-1"> 
						<a class="me-1 mb-1 btn-sm btnClr" href="#filtrosBusquedaVisor" data-bs-toggle="collapse" aria-expanded="false" aria-controls="filtrosBusquedaVisor"> Filtros </a> 
					</span> 
				</div>
				...
				<div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="kanbanMenu">
					...
					<!-- 
					<a class="dropdown-item" href="javascript:abrirModal();" id="LISTA_NEGRA_ETQ200">Busqueda de RFC</a>
					 -->
				</div>
	...
	<div class="card-header">
        ...
        <div class="mb-2 row">
        	<label class="col-sm-1 col-form-label" for="rfcListaNegra" id="LISTA_NEGRA_ETQ6">RFC</label>
				...
				<label class="col-sm-2 col-form-label" for="tipoFactura" id="LISTA_NEGRA_ETQ13">Tipo Factura</label>
				<div class="col-sm-3">
					<div class="form-group">
					   <select id="cmbTipoFactura" name="tipoFactura" class="form-select"> 
        ...
        <div class="mb-2 row">
				...
				<div class="col-sm-2">
					<div class="form-group">
					   <button class="btn btn-falcon-success btn-sm mb-2 mb-sm-0" type="button" onclick="refrescarEmpresa();" id="btnRefrescar_Nomina" ><span class="fab fa-firefox-browser me-1"></span> <span id="LISTA_NEGRA_ETQ8"> Refrescar </span> </button>
					</div>
				</div>
        </div>
	</div>
...
<form action="/siarex247/excel/descargarListaNegraPDF.action" name="frmDescargarPDF" id="frmDescargarPDF" target="frmOcultoSiarex" method="post">
...
$(document).ready(function() {
	$("#detColumnas").load('/siarex247/jsp/estatusXML/listaNegraEmpresa/listaColumnas.jsp');
	$("#myModalBusqueda").load('/siarex247/jsp/estatusXML/listaNegraEmpresa/modalBusqueda.jsp');
	...
	$('#cmbTipoFactura').select2({
		theme: 'bootstrap-5'
	});
	$('#cmbTipoFactura').val(''); // Selecciona primer valor del combo
	$('#cmbTipoFactura').trigger('change'); //Refresca el combo
	
	cargaCmbSupuestos();
	cargaCmbNombreArticulo();
	calcularEtiquetasListaNegraEmpXML();
	 
});



function calcularEtiquetasListaNegraEmpXML(){
		$.ajax({
			...
			success  : function(data) {
				if($.isEmptyObject(data)) {
					...
					document.getElementById("LISTA_NEGRA_ETQ13").innerHTML = data.ETQ13;
