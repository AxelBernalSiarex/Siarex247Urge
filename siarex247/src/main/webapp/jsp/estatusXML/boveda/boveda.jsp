	...
	<div class="card-header">
		<div class="row flex-between-end">
			<div class="col-auto align-self-center">
				<h5 class="mb-0" data-anchor="data-anchor" id="BOVEDA_TITLE2">Boveda Siarex</h5>
			</div>
					   ...
					   <%if ("ADM".equalsIgnoreCase(userForm.getNombreCortoPerfil()) || "010".equalsIgnoreCase(userForm.getNombreCortoPerfil())) { %>
						<li class="nav-item text-nowrap" role="presentation">
							<a class="nav-link mb-0 d-flex align-items-center gap-1 py-3 px-x1 active" id="tabBovedaRecibidos" data-bs-toggle="tab" href="#bovedaRecibidos" role="tab" aria-controls="bovedaRecibidos" aria-selected="true">
								...
								<h6 class="mb-0 text-600 fontTituloTab" style="padding-left: 10px;" id="BOVEDA_ETQ46">Recibidos</h6>
							</a>
						</li>
						<li class="nav-item text-nowrap" role="presentation">
							<a class="nav-link mb-0 d-flex align-items-center gap-1 py-3 px-x1" id="tabBovedaEmitidos" data-bs-toggle="tab" href="#bovedaEmitidos" role="tab" aria-controls="bovedaEmitidos" aria-selected="false">
								...
								<h6 class="mb-0 text-600 fontTituloTab" style="padding-left: 10px;" id="BOVEDA_ETQ47">Emitidos</h6>
                      		</a>
                      	</li>
                      	<li class="nav-item text-nowrap" role="presentation">
							<a class="nav-link mb-0 d-flex align-items-center gap-1 py-3 px-x1" id="tabBovedaNomina" data-bs-toggle="tab" href="#bovedaNomina" role="tab" aria-controls="bovedaNomina" aria-selected="false">
								...
								<h6 class="mb-0 text-600 fontTituloTab" style="padding-left: 10px;" id="BOVEDA_ETQ48">Nomina</h6>
                      		</a>
                      	</li>
...
//alarmaUsuario.html
	...
	$(document).ready(function() {
		<%if ( (!"007".equalsIgnoreCase(userForm.getNombreCortoPerfil()) && !"009".equalsIgnoreCase(userForm.getNombreCortoPerfil()) ) || "ADM".equalsIgnoreCase(userForm.getNombreCortoPerfil())) { %>
			$("#bovedaRecibidos").load('/siarex247/jsp/estatusXML/boveda/recibidos/bovedaRecibidos.jsp');
		<%}else {%>
			$("#bovedaNomina").load('/siarex247/jsp/estatusXML/boveda/nomina/bovedaNomina1.jsp');
		<%}%>
		...
		$('.nav-tabs a').on('shown.bs.tab', function(event){
			...
			if (id == "tabBovedaRecibidos") {
				...
				<%if ( (!"007".equalsIgnoreCase(userForm.getNombreCortoPerfil()) && !"009".equalsIgnoreCase(userForm.getNombreCortoPerfil()) ) || "ADM".equalsIgnoreCase(userForm.getNombreCortoPerfil())) { %>
					$("#bovedaEmitidos").load('/siarex247/jsp/estatusXML/boveda/emitidos/bovedaEmitidos.jsp');
				<%}%>
		...
		calcularEtiquetasBovedaPrincipal();
				
	});
	
	

	 function calcularEtiquetasBovedaPrincipal(){
			$.ajax({
				...
				success  : function(data) {
					if($.isEmptyObject(data)) {
						...
						document.getElementById("BOVEDA_TITLE2").innerHTML = data.TITLE2;
						document.getElementById("BOVEDA_ETQ46").innerHTML = data.ETQ46;
						document.getElementById("BOVEDA_ETQ47").innerHTML = data.ETQ47;
						// document.getElementById("BOVEDA_ETQ48").innerHTML = data.ETQ48;
				...
				error : function(xhr, ajaxOptions, thrownError) {
					alert('calcularEtiquetasBovedaPrincipal()_1_'+thrownError);
				}
			});	
		}
