...
<form id="frm-Carga-XML" class="was-validated" novalidate>
		...
		<div class="modal-content position-relative">
			<div class="modal-body p-0">
				<div class="rounded-top-3 py-3 ps-4 pe-6 bg-light">
	   				<h5 class="mb-1" id="BOVEDA_ETQ28">Cargar Archivos XML a Boveda</h5>
				...
				<div class="p-4 pb-0">
				  <div class="mb-2 row">
						<label class="col-sm-4 col-form-label" for="filesXML" id="BOVEDA_ETQ29">Archivos XML</label>
						<div class="col-sm-8">
 ...
 <script type="text/javascript">
   ...
   $(document).ready(function() {
	   ...
	   calcularEtiquetasBovedaModal();
	   	   
	});
   
   

	 function calcularEtiquetasBovedaModal(){
			$.ajax({
				...
				success  : function(data) {
					if($.isEmptyObject(data)) {
						...
						document.getElementById("BOVEDA_ETQ28").innerHTML = data.ETQ28;
						document.getElementById("BOVEDA_ETQ29").innerHTML = data.ETQ29;
						document.getElementById("btnSometer").innerHTML = BTN_PROCESAR_MENU;
						document.getElementById("BOVEDA_Boton_Cancelar").innerHTML = BTN_CANCELAR_MENU;
