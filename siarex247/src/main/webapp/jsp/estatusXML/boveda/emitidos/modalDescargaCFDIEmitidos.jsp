...
<form id="frmExportXMLEmitidos" class="was-validated" novalidate>
				   ...
				   <div class="mb-2 row">
						...
						<div class="col-sm-8">
							<div class="form-group">
								<select class="form-select" id="modoAgrupar_Emitidos" name="modoAgrupar" required>
					...
					<div class="mb-2 row">
						<label class="col-sm-4 col-form-label" for="CORREO_RESPONSABLE_EMITIDOS" id="EXPORTARXML_ETQ16">Correo de notificaci&oacute;n al responsable</label>
						<div class="col-sm-8">
							<input id="CORREO_RESPONSABLE_EMITIDOS" name="correoResponsable" class="form-control" type="email" required />
						</div>
					</div>
					...
					<div class="mb-2 row">
						...
						<div class="col-sm-2">
							<div class="form-check form-switch">
								<input class="form-check-input" id="validarSAT_Emitidos" name="validarSAT" type="checkbox"  />
							</div>
						</div>
					...
					<div class="mb-2 row">
						...
						<div class="col-sm-2">
							<div class="form-check form-switch">
								<input class="form-check-input" id="complementoSAT_Emitidos" name="complementoSAT" type="checkbox"  />
							</div>
						</div>
					</div>
					...
					<div class="mb-2 row">
						...
						<div class="col-sm-2">
							<div class="form-check form-switch">
								<input class="form-check-input" id="notaCreditoSAT_Emitidos" name="notaCreditoSAT" type="checkbox"  />
							</div>
						</div>
					</div>
				</div>
 ...
 <script type="text/javascript">
   ...
   $(document).ready(function() {
	   ...
	   $("#frmExportXMLEmitidos").on('submit', function (event) {
	   ...
	   calcularEtiquetasDescargaCFDIEmitidos();
	});
   
   

	function iniciaFormDescargaCFDI_Emitidos(){
		/* Reset al Formulario */ 
		$("#frmExportXMLEmitidos").find('.has-success').removeClass("has-success");
	    $("#frmExportXMLEmitidos").find('.has-error').removeClass("has-error");
		$('#frmExportXMLEmitidos')[0].reset(); 
		$('#frmExportXMLEmitidos').removeClass("was-validated"); 
		   
	}
	 
	

	function asignarCorreoEmitidos(){
		try{
			...
			$.ajax({
				...
				success  : function(data) {
	 				if (data == null){
	 					...
	 					$('#CORREO_RESPONSABLE_EMITIDOS').val(data.correo);
	 				}
					
				},
				error : function(xhr, ajaxOptions, thrownError) {
					alert('asignarCorreoEmitidos()_'+thrownError);
				}
			});			
			
		}catch(e){
			alert('asignarCorreoEmitidos()_'+e);
		}
	 }
	
	
	 function calcularEtiquetasDescargaCFDIEmitidos(){
			$.ajax({
