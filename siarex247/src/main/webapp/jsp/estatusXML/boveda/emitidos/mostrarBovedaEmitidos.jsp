...
<%@page import="com.siarex247.cumplimientoFiscal.BovedaEmitidos.BovedaEmitidosAction"%>
...
<%
    ...
    int idRegistro = Utils.noNuloINT(request.getParameter("f"));
	String tipoRegistro = request.getParameter("t");
     
    BovedaEmitidosAction bovedaAction = new BovedaEmitidosAction();
