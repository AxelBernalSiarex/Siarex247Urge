...
//				dom: "<'row mx-0'<'col-md-12'QB><'col-md-6'l><'col-md-6'f>>" + "<'table-responsive scrollbar'tr>" + "<'row g-0 align-items-center justify-content-center justify-content-sm-between'<'col-auto mb-2 mb-sm-0 px-0'i><'col-auto px-0'p>>",
				...
				buttons: [
					{ 	extend: "collection",
				    	...
				    	buttons: [
				    		{ extend: "excel", text:'Exportar Excel',  title: 'Reporte de Validación Carta Porte', exportOptions: {modifier: {selected: null, page: 'all'}}, filename: 'ReporteValidacionCP'} 
				        ], 
			      	}
				],
				language : {
				...
				ajax : {
					url: '/siarex247/estadisticas/repCartaPorte/detalleReporte.action',
					type: 'POST'
				},
				aoColumns : [
					{ mData: "idRegistro", "sClass": "alinearCentro"},
					{ mData: "folioEmpresa", "sClass": "alinearCentro"},
					{ mData: "razonSocial", "sClass": "alinearIzquierda"},
					{ mData: "etiqueta", "sClass": "alinearIzquierda"},
					{ mData: "valorXML", "sClass": "alinearIzquierda"},
					{ mData: "estatus", "sClass": "alinearIzquierda"},
					{ mData: "resultado", "sClass": "alinearIzquierda"},
