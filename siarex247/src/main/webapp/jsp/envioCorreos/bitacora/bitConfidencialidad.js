...
//				dom: "<'row mx-0'<'col-md-12'QB><'col-md-6'l><'col-md-6'f>>" + "<'table-responsive scrollbar'tr>" + "<'row g-0 align-items-center justify-content-center justify-content-sm-between'<'col-auto mb-2 mb-sm-0 px-0'i><'col-auto px-0'p>>",
				...
				buttons: [
					{ 	extend: "collection",
				    	...
				    	buttons: [
				    		{ extend: "excel", text:'Exportar Excel',  title: 'Bitacora de Confidencialidad', exportOptions: {modifier: {selected: null, page: 'all'}}, filename: 'bitacoraConfidencialidad'},
				    		{ extend: "pdf", text:'Exportar PDF', orientation: "landscape", pageSize: "LEGAL", title: "Bitacora de Confidencialidad", filename: 'bitacoraConfidencialidad', exportOptions: { modifier: { page: "all", }, }, }, 
				        ], 
			      	}
				],
				language : {
				...
				ajax : {
					url: '/siarex247/seguridad/bitacora/detalleHistorico.action',
					data : null,
					type: 'POST'
				},
				aoColumns : [
					{ mData: "descripcion", "sClass": "alinearCentro"},
					{ mData: "nombreUsuarioHTTP"},
					{ mData: "tipoProveedor"},
					{ mData: "fechaTarea"},
					{ mData: "razonSocial"}
				],
