...
<html>
  ...
  <meta http-equiv="Expires" content="0">
	...
	<script src="/siarex247/jsp/configuraciones/cfdi/etiquetas/etiquetasXMLVal.js"></script>
    <script>
          ...
          <div class="p-4 pb-0">
				<div class="col-sm-12 text-end">
					<div class="form-group text-end" style="margin-bottom: 10px;">
					   <button class="btn btn-falcon-success btn-sm mb-2 mb-sm-0" type="button" onclick="refrescarEtiqueta();" id="btnRefrescar_Etiqueta" ><span class="fab fa-firefox-browser me-1"></span> <span id="BOVEDA_ETQ11"> Refrescar </span>  </button>
					</div>
				</div>
