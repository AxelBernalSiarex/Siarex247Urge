		...
		<div class="modal-content position-relative">
			...
			<div class="modal-body p-0">
				<div class="rounded-top-3 py-3 ps-4 pe-6 bg-light modalTitulo">
	   				<h5 class="mb-1" id="modal-title-catalogo">Editar Configuraci&oacute;n a Etiquetas del XML</h5>
				</div>
				<div class="p-4 pb-3">
							...
							<ul class="nav nav-tabs border-0 flex-column flex-sm-row" id="tabAlarmas" role="tablist">
								<li class="nav-item text-nowrap" role="presentation">
									<a class="nav-link mb-0 d-flex align-items-center gap-1 py-3 px-x1 active" id="tabInfoPrincipal" data-bs-toggle="tab" href="#infoPrincipal" role="tab" aria-controls="infoPrincipal" aria-selected="true">
										...
										<h6 class="mb-0 text-600 fontTituloTab" style="padding-left: 10px;" id="CONF_CFDI_ETIQUETAS_ETQ21">Configuraci&oacute;n de Etiqueta</h6>
									</a>
								</li>
								...
								<div class="accordion" id="accordion1">
									...
									<div class="accordion-item"><!-- accordion-item Datos Generales -->
    									<h2 class="accordion-header" id="heading1">
      										<button class="accordion-button bg-200" type="button" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="true" aria-controls="collapse1" id="CONF_CFDI_ETIQUETAS_ETQ19">Configuraci&oacute;n General</button>
    									</h2>
    									<div class="accordion-collapse collapse show" id="collapse1" aria-labelledby="heading1" data-bs-parent="#accordion1">
      										<div class="accordion-body">
      											<div class="mb-2 row">
									              <label class="col-sm-3 col-form-label" for="etiqueta" id="CONF_CFDI_ETIQUETAS_ETQ12">Etiqueta del XML </label>
									              <div class="col-sm-9">
									                <input id="etiqueta" name="etiqueta" class="form-control" type="text" readonly="readonly" />
									              </div>
									            </div>
      											<div class="mb-2 row">
									              <label class="col-sm-3 col-form-label" for="fechaInicial" id="CONF_CFDI_ETIQUETAS_Etiqueta_FechaInicio">Fecha de Inicio</label>
									              <div class="col-sm-9">
									            ...
									            <div class="mb-2 row">
									              <label class="col-sm-3 col-form-label" for="fechaFinal" id="CONF_CFDI_ETIQUETAS_Etiqueta_FechaFinal">Fecha Final</label>
									              <div class="col-sm-9">
									                <div class="form-group">
									            ...
									            <div class="mb-2 row">
													<label class="col-sm-3 col-form-label" for="txtAsunto" id="CONF_CFDI_ETIQUETAS_ETQ13" >Activar Configuraci&oacute;n </label>
									              <div class="col-sm-9">
									            ...
									            <div class="mb-2 row">
									              <label class="col-sm-3 col-form-label" for="subject" id="CONF_CFDI_ETIQUETAS_ETQ14">Asunto </label>
									              <div class="col-sm-9">
									                <input id="subject" name="subject"  class="form-control" type="text" required />
									              </div>
									            </div>
									            <div class="mb-2 row">
									              <label class="col-sm-3 col-form-label" for="mensajeError" id="CONF_CFDI_ETIQUETAS_ETQ15">Mensaje de Error</label>
									              <div class="col-sm-9">
  									...
  									<div class="accordion-item"> 
										<h2 class="accordion-header" id="heading2">
											<button class="accordion-button bg-200 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse2" aria-expanded="true" aria-controls="collapse2"  id="CONF_CFDI_ETIQUETAS_ETQ20">Datos a Validar</button>
										</h2>
			...
			<div class="modal-footer">	
				...
				<button class="btn btn-secondary" type="button" id="CONF_CFDI_ETIQUETAS_Boton_Cerrar" data-bs-dismiss="modal">Cerrar</button>
			</div>
		</div>
	</div>
</form>
			...
			$.ajax({
				...
				success  : function(data) {
					if($.isEmptyObject(data)) {
						...
						document.getElementById("modal-title-catalogo").innerHTML = data.ETQ11;
						document.getElementById("CONF_CFDI_ETIQUETAS_ETQ12").innerHTML = data.ETQ12;
						document.getElementById("CONF_CFDI_ETIQUETAS_ETQ13").innerHTML = data.ETQ13;
						document.getElementById("CONF_CFDI_ETIQUETAS_ETQ14").innerHTML = data.ETQ14;
						document.getElementById("CONF_CFDI_ETIQUETAS_ETQ15").innerHTML = data.ETQ15;
						document.getElementById("CONF_CFDI_ETIQUETAS_Etiqueta_FechaInicio").innerHTML = data.ETQ4;
						document.getElementById("CONF_CFDI_ETIQUETAS_Etiqueta_FechaFinal").innerHTML = data.ETQ5;
						document.getElementById("CONF_CFDI_ETIQUETAS_ETQ19").innerHTML = data.ETQ19;
						document.getElementById("CONF_CFDI_ETIQUETAS_ETQ20").innerHTML = data.ETQ20;
						document.getElementById("CONF_CFDI_ETIQUETAS_ETQ21").innerHTML = data.ETQ21;
						
						document.getElementById("btnSometer").innerHTML = BTN_GUARDAR_MENU;
						document.getElementById("CONF_CFDI_ETIQUETAS_Boton_Cerrar").innerHTML = BTN_CERRAR_MENU;
