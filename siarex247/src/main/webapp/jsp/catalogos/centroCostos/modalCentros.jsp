...
<form id="form-Catalogo" class="was-validated" novalidate>
		...
		<div class="modal-content position-relative">
			<div class="modal-body p-0">
				...
				<div class="p-4 pb-0">
					...
					<div class="mb-2 row">
						<label class="col-sm-4 col-form-label" for="txtIdCentro" id="CAT_CENTROS_Etiqueta_CentroCostos">Id. Centro de Costos </label>
						<div class="col-sm-8">
	   						<input id="txtIdCentro" name="idCentro" class="form-control validarHabilitar" type="text"  maxlength="5" required />
	 					</div>
					</div>

					<div class="mb-2 row">
						<label class="col-sm-4 col-form-label" for="txtDepartamento" id="CAT_CENTROS_Etiqueta_Departamento">Departamento</label>
						<div class="col-sm-8">
	   						<input id="txtDepartamento" name="departamento" class="form-control validarHabilitar" type="text" maxlength="100" required />
	 					</div>
					</div>


					<div class="mb-2 row">
						<label class="col-sm-4 col-form-label" for="txtCorreo" id="CAT_CENTROS_Etiqueta_Correo">Correo</label>
						<div class="col-sm-8">
	   						<input id="txtCorreo" name="correo" class="form-control validarHabilitar" type="email" maxlength="64" required />
	 					</div>
					</div>
 ...
 <script type="text/javascript">
   ...
   $(document).ready(function() {
	   ...
	   calcularEtiquetasCatalogoCentrosModal();
