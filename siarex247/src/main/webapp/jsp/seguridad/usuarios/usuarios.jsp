...
<head>
	<script src="/siarex247/jsp/seguridad/usuarios/usuarios.js?v=<%=Utils.VERSION%>"></script>
	...
	<div class="card-header">
		<div class="row flex-between-end">
			<div class="col-auto align-self-center">
				<h5 class="mb-0" data-anchor="data-anchor">Catálogo de Usuarios</h5>
			</div>
					...
					<table id="tablaDetalle"class="table mb-0 data-table fs--1">
						<thead class="bg-200 text-900">
							 <tr>
							    ...
							    <th class="sort pe-1 align-middle white-space-nowrap">Id. Registro</th>
								<th class="sort pe-1 align-middle white-space-nowrap">Id. Usuario</th>
								<th class="sort pe-1 align-middle white-space-nowrap">Nombre Completo</th>
								<th class="sort pe-1 align-middle white-space-nowrap">Id. Empleado</th>
								<th class="sort pe-1 align-middle white-space-nowrap">Correo</th>
								<th class="sort pe-1 align-middle white-space-nowrap">Perfil</th>
								<th class="sort pe-1 align-middle white-space-nowrap">Descripci&oacute;n</th>
								<th class="sort pe-1 align-middle white-space-nowrap">Tipo de Perfil</th>
                              </tr>
                               <tr class="forFilters">
                                  <th></th>
								  <th></th>
...
<script type="text/javascript">
	$(document).ready(function() {
		$("#myModalDetalle").load('/siarex247/jsp/seguridad/usuarios/modalUsuarios.jsp');  
	});
</script>
